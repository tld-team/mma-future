    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-gray-700 p-6 rounded-lg">
                ...
                <ul class="space-y-3">
                    <li class="flex justify-between">
                        <span class="text-gray-400">Nadimak:</span>
                        <span class="font-bold">Haker</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Datum rođenja:</span>
                        <span class="font-bold">15.03.1990.</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Visina:</span>
                        <span class="font-bold">191 cm</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Težina:</span>
                        <span class="font-bold">112 kg</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Zemlja:</span>
            ...
            <div class="bg-gray-700 p-6 rounded-lg">
                ...
                <ul class="space-y-3">
                    <li class="flex justify-between">
                        <span class="text-gray-400">Primarni stil:</span>
                        <span class="font-bold">Boks</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Sekundarni stil:</span>
                        <span class="font-bold">Brazilski Džiu-džicu</span>
                    </li>
                    <li class="flex justify-between">
                        <span class="text-gray-400">Raspon ruku:</span>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between mb-1">
                            <span class="text-gray-400">Ukupno borbi:</span>
                    ...
                    <div>
                        <div class="flex justify-between mb-1">
                            <span class="text-gray-400">Pobede:</span>
                    ...
                    <div>
                        <div class="flex justify-between mb-1">
                            <span class="text-gray-400">Nokauti:</span>
            ...
            <div class="bg-gray-700 p-6 rounded-lg">
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start">
                        <i class="fas fa-medal text-gray-300 mt-1 mr-2"></i>
                        <span>Performance of the Night (5x)</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-medal text-amber-700 mt-1 mr-2"></i>
                        <span>Fight of the Night (3x)</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-award text-red-500 mt-1 mr-2"></i>
