        ...
        <div class="flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-2/5 mb-10 md:mb-0 flex justify-center">
                <div class="fighter-image relative">
                    ...
                    <div class="absolute -bottom-4 -right-4 bg-primary text-button-text px-4 py-2 rounded-lg font-heading font-bold">
                        #1 UFC
                    </div>
                </div>
            </div>
            ...
            <div class="md:w-3/5 md:pl-12">
                <h1 class="text-4xl md:text-6xl font-heading font-bold mb-2">Marko "Haker" Petrović</h1>
                <div class="flex items-center mb-6">
                    <span class="bg-secondary-700 px-3 py-1 rounded mr-3">Teška kategorija</span>
                ...
                <div class="stats-gradient p-6 rounded-lg mb-8">
                    <h2 class="text-2xl font-heading font-bold mb-4">Statistike</h2>
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-muted">Nokauta</div>
                        </div>
                        <div class="text-center">
                            <div class="text-3xl font-bold text-primary">4</div>
                            <div class="text-muted">Podnesi</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap gap-4">
                    <button class="!bg-primary hover:!bg-primary-600 !px-6 !py-3 !rounded-lg font-heading !font-bold flex items-center transition btn-primary text-button-text">
                        <i class="fas fa-play-circle mr-2"></i> Poslednja Borba
                    </button>
                    <button class="!bg-secondary-700 hover:!bg-secondary-600 !px-6 !py-3 !rounded-lg font-heading !font-bold flex items-center transition">
                        <i class="fas fa-trophy mr-2"></i> Dostignuća
                    </button>
                    <button class="!border !border-primary !text-primary hover:!bg-primary hover:!text-button-text !px-6 !py-3 !rounded-lg font-heading !font-bold flex items-center transition">
